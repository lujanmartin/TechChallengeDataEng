...
from movies_data_pipeline.config.auth import SECRET_KEY, ALGORITHM, ACCESS_TOKEN_EXPIRE_MINUTES
import logging
import os
...
class AuthService:
    ...
    def authenticate_user(self, username: str, password: str) -> dict:
        if username != HARDCODED_USERNAME or not self.verify_password(password, HARDCODED_PASSWORD_HASH):
